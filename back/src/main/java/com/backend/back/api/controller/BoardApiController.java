...
public class BoardApiController {
     ...
     */
    @GetMapping
    public ListResult<Board> getBoardList() {
    ...
    public SingleResult<BoardCommentResponse> getBoard(@PathVariable("id") Long id) {
        ...
        BoardCommentResponse boardCommentResponse=new BoardCommentResponse(board_byId,commentResponses);

        return responseService.getSingleResult(boardCommentResponse);
    }
